...
import 'package:food_app/screens/check_out/delivery_address/single_delivery_item.dart';
          ...
          itemBuilder: (context, index) {
            return Column(
              children: [
                SingleDeliveryItem(
                  address:
                      "aera, ${widget.deliverAddressList.area}, street, ${widget.deliverAddressList.street}, society ${widget.deliverAddressList.society}, pincode ${widget.deliverAddressList.pinCode}",
                  title:
